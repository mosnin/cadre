...
/** Chippi keeps its orange action color on the imported authenticated client. */
export const chippiDarkTokens: ColorTokens = {
  ...darkTokens,
  primary: "#ff964f",
...
export const chippiLightTokens: ColorTokens = {
  ...lightTokens,
  primary: "#ff964f",
  primaryForeground: "#1c1c1c",
  ring: "#a34100",
...
export function renderTokensCss(): string {
  return `${[
    ...
    renderBlock(
      'html[data-chippi-host], html[data-chippi-host][data-theme="dark"]',
      "dark",
      chippiDarkTokens,
    ),
    renderBlock('html[data-chippi-host][data-theme="light"]', "light", chippiLightTokens),
  ].join("\n\n")}\n`;
}
