...
const COMBOBOX_INSTANT = { duration: 0 };
...
export function ComboboxItem({
  ...
  return (
    <button
      ...
      className={cn(
        "relative flex min-h-11 w-full items-center gap-2 rounded-lg px-2 py-2 text-left text-sm outline-none transition-colors duration-150",
    ...
    >
      {active ? (
        <motion.span
          ...
          transition={context.reduce ? { duration: 0 } : COMBOBOX_INSTANT}
        />
      ) : null}
