...
export function Table<T>({
  ...
  const totalSize = virtualize ? virtualizer.getTotalSize() : sortedRows.length * rowHeight;
  ...
  return (
    ...
    >
      <div
        ...
        style={{ height: virtualize ? height : undefined }}
      >
        <table
                ...
                {virtualItems.map((vItem) => {
                  ...
                  return (
                    <tr
                      ...
                      style={{ height: virtualize ? rowHeight : undefined }}
                      onPointerEnter={
                    ...
                    >
                      ...
                      {orderedColumns.map((column) => (
                        <td
                          key={column.key}
                          className={cn("px-4 py-3 text-foreground", alignText(column.align))}
                        >
