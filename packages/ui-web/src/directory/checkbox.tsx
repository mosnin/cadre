...
import { EASE_OUT, SPRING_PRESS } from "./support/ease";
  ...
  return (
    ...
    >
      <motion.button
        ...
        className={cn(
          "inline-flex h-5 w-5 shrink-0 items-center justify-center rounded-md border outline-none transition-colors duration-200",
