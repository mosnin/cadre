...
import { PreviewRail, type PreviewRailItem } from "./preview-rail";
...
export interface MessageScrollerProps extends ComponentPropsWithRef<"div"> {
  ...
  viewportProps?: { "data-testid"?: string } & Omit<
...
export function MessageScroller({
  ...
  const viewport = (
    <section
      ref={setViewportRef}
      // biome-ignore lint/a11y/noNoninteractiveTabindex: The transcript viewport supports keyboard scrolling.
      tabIndex={0}
      aria-label={label}
      {...restViewportProps}
      onScroll={(event) => {
