...
import { EASE_OUT, SPRING_LAYOUT, SPRING_SWAP } from "./support/ease";
...
function bubbleContentClass(variant: MessageBubbleVariant, interactive: boolean) {
  return cn(
    "relative z-0 min-w-9 max-w-[88%] sm:max-w-[82%] rounded-2xl px-4 py-3 text-base leading-6 text-foreground",
