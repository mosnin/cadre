 ...
 */
export const PUBLISHED_IMAGE_REPO = "mosnin/cadre";
...
export const IMAGE_TAG_ENV = "CADRE_IMAGE_TAG";
export const PREVIOUS_IMAGE_TAG_ENV = "CADRE_IMAGE_TAG_PREVIOUS";
 ...
 */
export const DEFAULT_COMPOSE_PROJECT_NAME = "cadre-prod";
export const COMPOSE_PROJECT_NAME_ENV = "COMPOSE_PROJECT_NAME";
export const COMPOSE_PROJECT_NAME_OVERRIDE_ENV = "CADRE_COMPOSE_PROJECT_NAME";
 ...
 * absent because neither uses the Cadre image.
 */
...
/**
 * `updaterUrlConfigured` means the API was given `CADRE_UPDATER_URL` (Compose prod always sets
