...
export interface SandboxProvider {
  ...
  /** Verify that stopping this owned computer retains its workspace for the next boot. */
  preservesWorkspaceOnStop?(computer: ComputerRef, context: AdapterContext): Promise<boolean>;
