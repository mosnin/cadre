    ...
    const result = spawnSync(
      ...
      [
        ...
        [
          ...
          "glide = module.pointer_glide_steps",
          "module.POINTER_AT[':1'] = (0, 0)",
          "path = glide(['env', 'DISPLAY=:1', 'xdotool', 'mousemove', '--', '400', '300', 'click', '1'], ':1')",
          "assert any('waitMs' in step for step in path)",
          "assert path[-1]['argv'][-1] == '1'",
