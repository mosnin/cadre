...
Vendored from [typesafe-ai/skills](https://github.com/typesafe-ai/skills) (MIT, see LICENSE
beside this file) so the guidance travels with the repository rather than depending on a
per-machine plugin install. Refresh it with:
