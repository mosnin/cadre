...
The web consent document refuses framing through CSP and X-Frame-Options in Vite development/preview and the Vercel build output. Its component also refuses framed approval, including alternate SPA URLs. Custom static hosts must preserve those response headers. The browser acceptance test checks the canonical response headers.
