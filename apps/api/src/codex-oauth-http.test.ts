import { CODEX_CLIENT, createCodexOAuth } from "@cadre/auth/codex-oauth";
import { Hono } from "hono";
import { beforeEach, expect, it, vi } from "vitest";
import { mountCodexOAuth } from "./codex-oauth-http.js";

vi.mock("@cadre/auth/codex-oauth", async (importOriginal) => ({
  ...(await importOriginal<typeof import("@cadre/auth/codex-oauth")>()),
