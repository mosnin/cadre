export const ZH_MESSAGES: Record<string, string> = {
  ...
  Back: "返回",
  "Could not load library": "无法加载资料库",
  "Could not save changes": "无法保存更改",
  "Export bundle": "导出插件包",
  "File sharing is unavailable on this device": "此设备无法共享文件",
  "Import plugin": "导入插件",
  "Import skill or plugin bundle": "导入技能或插件包",
  "Make a copy": "创建副本",
  "New skill or workflow": "新建技能或工作流",
  "Plugin bundle is too large": "插件包过大",
  "Plugin documents will be saved in this workspace. Hooks and servers are not activated by importing.":
    "插件文档将保存在此工作区。导入不会启用钩子或服务器。",
  "Plugin name": "插件名称",
  Plugins: "插件",
  "Remove from workspace?": "从工作区移除？",
  "Save instructions here, or ask an agent to create a reusable skill or workflow.":
    "在此保存指令，或让智能体创建可重复使用的技能或工作流。",
  "Skill files must be 100 KB or less": "技能文件不得超过 100 KB",
  "Skills and workflows": "技能与工作流",
  "Steps and instructions": "步骤与指令",
  "When to use it": "使用时机",
  "Workspace library": "工作区资料库",

  Apps: "应用",
  "Could not delete schedule": "无法删除计划",
  "Could not load custom plugins": "无法加载自定义插件",
  "Could not load schedules": "无法加载计划",
  "Could not save schedule": "无法保存计划",
  Credential: "凭据",
  "Custom plugins": "自定义插件",
  "Daily at 9 AM": "每天上午 9 点",
  "Delete schedule": "删除计划",
  "Delete schedule?": "删除计划？",
  "Enter a name and instruction": "请输入名称和指令",
  Hourly: "每小时",
  Instruction: "指令",
  "New schedule": "新建计划",
  "No schedules yet": "暂无计划",
  "Notify me": "通知我",
  "Schedule expressions, one per line": "计划表达式，每行一个",
  Schedules: "计划",
  ...
  Light: "浅色",
  System: "跟随系统",
  "{count} agents thinking": "{count} 个智能体正在思考",
  ...
  "Enter your Cadre server address.": "输入你的 Cadre 服务器地址。",
  "Show less": "收起",
  Members: "成员",
  ...
  "Point this app at your self-hosted Cadre origin, the same HTTPS URL you open in a browser.":
    "将此应用指向你自托管的 Cadre 源站，地址与你在浏览器中打开的 HTTPS URL 相同。",
  Private: "私有",
  Providers: "提供商",
  ...
  "Show {label}": "显示 {label}",
  "Sign in": "登录",
  "Sign in to Cadre": "登录 Cadre",
  "Sign out": "退出登录",
  "Sign up": "注册",
  "Sign up for Cadre": "注册 Cadre",
  "Sign-in": "登录",
  "Sign-up": "注册",
  ...
  "That URL did not look like a Cadre server": "该地址看起来不是 Cadre 服务器",
  ...
  "Paste the OpenAI-compatible address from your server. Cadre adds /v1 if needed.":
    "粘贴你服务器的 OpenAI 兼容地址。如有需要，Cadre 会自动补上 /v1。",
  Paused: "已暂停",
  Prompt: "提示词",
  ...
  "This subscription sign-in is not available in Cadre yet. Use a deployment credential or choose another provider.":
    "Cadre 暂不支持此订阅登录。请使用部署凭据或选择其他提供商。",
  "Tool sources": "工具源",
  ...
  "Connect another company": "连接另一家公司",
  Connections: "连接",
  "Could not load connections": "无法加载连接",
  Disconnect: "断开连接",
  "Disconnect {name}?": "要断开 {name} 吗？",
  "Not available on this server": "此服务器不提供",
  "Plugin bundles": "插件包",
  Region: "地区",
  "Set time zone automatically": "自动设置时区",
  "Day of month": "每月第几天",
  "Every day": "每天",
  "Every month": "每月",
  "Every week": "每周",
